...
export default function AdminPanel({
  ...
  const t = {
    en: {
      ...
      bankTxLabel: "Bank Transaction Reference (TXID / FT Code)",
      expiresInLabel: "Expiration Time (Minutes)",
      clearExpiredBtn: "Delete Expired Codes",
      searchByEmailOrTx: "Search by Email, TXID or FT Code...",
      ...
      cancelBtn: "Cancel",
      proTipAgent: "Pro Tip: Make sure the registered Agent name and Telebirr number are accurate and active.",
    ...
    am: {
      ...
      bankTxLabel: "የባንክ ማስተላለፊያ ማጣቀሻ (TXID / FT ኮድ)",
      expiresInLabel: "የማለፊያ ጊዜ (በደቂቃዎች)",
      clearExpiredBtn: "ጊዜያቸው ያለፈባቸውን ሰርዝ",
      searchByEmailOrTx: "በኢሜይል፣ በTXID ወይም በFT ኮድ ይፈልጉ...",
      ...
      addAgentBtn: "ወኪል ጨምር",
      cancelBtn: "ሰርዝ",
      proTipAgent: "ጠቃሚ ምክር፡ የተመዘገበው የወኪል ስም እና የቴሌብር ቁጥር ትክክለኛ እና ንቁ መሆናቸውን ያረጋግጡ።",
