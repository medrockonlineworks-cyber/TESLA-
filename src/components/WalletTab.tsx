...
export default function WalletTab({
  ...
  const t = {
    en: {
      ...
      txidLabel: "Transaction ID (TxID / FT Code)",
      txidPlaceholder: "Enter TxID or FT Code (e.g. FT26...)",
    ...
    am: {
      ...
      txidLabel: "የማስተላለፊያ መለያ (TxID / FT ኮድ)",
      txidPlaceholder: "የማስተላለፊያ መለያ ወይም የ FT ኮድ ያስገቡ (ለምሳሌ FT26...)",
